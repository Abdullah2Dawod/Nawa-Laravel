                                    ...
                                    <ul id="nav" class="navbar-nav ms-auto">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="sub-menu collapse" id="submenu-1-3">
                                                <li class="nav-item active"><a href="product-grids.html">Mobiles</a>
                                                </li>
                                                <li class="nav-item"><a href="product-list.html">Laptops</a></li>
                                                <li class="nav-item"><a href="product-details.html">TVs</a></li>
                                                <li class="nav-item"><a href="cart.html">Watches</a></li>
                                                <li class="nav-item"><a href="cart.html">Mixers</a></li>
                                                <li class="nav-item"><a href="checkout.html">Refrigerators</a></li>
                                            </ul>
                                        </li>
                                        <li class="nav-item">
