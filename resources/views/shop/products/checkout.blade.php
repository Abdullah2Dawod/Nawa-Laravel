                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="email" name="customer_email"
                                                            value="{{ old('customer_email') }}" placeholder="Email Address">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text" name="customer_address"
                                                            value="{{ old('customer_address') }}" placeholder="Mailing Address">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text" name="customer_postal_code"
                                                            value="{{ old('customer_postal_code') }}" placeholder="Postal Code">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text" name="customer_province"
                                                            value="{{ old('customer_province') }}" placeholder="Province">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
